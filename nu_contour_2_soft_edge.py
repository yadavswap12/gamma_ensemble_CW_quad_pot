...
f_out=file("input_output_files/rho_2.0/contour/nu_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_18000points_iter"+str(iteration)+".txt","w")
f_out1=file("input_output_files/rho_2.0/contour/nu1_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_18000points_iter"+str(iteration)+".txt","w")
f_out2=file("input_output_files/rho_2.0/contour/nu2_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_18000points_iter"+str(iteration)+".txt","w")
...
data = numpy.loadtxt("input_output_files/rho_2.0/contour/nu_contour_c1="+str(c1_short)+"_c0="+str(c0_short)+"_18000points_iter"+str(iteration)+".txt",float)
x = data[:,0]
y = data[:,1]
