...
b0=0.0    # parameters of polynomial fit for f1(x), f1(x)=b0 + b1x + b2x^2 + b3x^3 + b4x^4 
b1=1.0    # gamma = 0.76
b2=-0.00333
b3=7.55816E-4
b4=0.00138
...
#Y =0.21889+1.2014 X-0.00333 X\+(2)+7.55816E-4 X\+(3)+0.00138 X\+(4)-2.20839E-4 X\+(5)-1.22855E-4 X\+(6)+2.94366E-5 X\+(7)-1.32863E-6 X\+(8)
